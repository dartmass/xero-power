# Chrome Web Store Listing — Xero Power

## Extension name
Xero Power — Shortcuts & Command Palette
...
・Solo Pro tools — search and open selected organisations in separate colour-coded tabs, and keep long-list controls within reach
...
2. **Bank Rec shortcuts** — show the Bank Reconciliation screen with the green hint bar at bottom
   - Window size: 1280×800  
   - File: screenshot-02-bankrec.png

3. (Optional) **Search demo** — palette open with "inv" typed, showing Invoice results
   - File: screenshot-03-search.png
